...
import CheckBox from "./Stages/WorkExperience/components/CheckBox";
    ...
    switch (subStageSlug) {
      ...
      case "idman-substage":
        ...
        case "is-tecrubesi-substage":
          return(
            <CheckBox    stageIndex={stageIndex || undefined}
            subStageSlug={subStageSlug || ""}/>
          );
          ...
          <h1 className="mb-4">
            <span className=" text-qss-secondary">
              {subStageName === "Dil Bilikləri substage"
               ...
               'İş Təcrübəsi': subStageName}
            </span>
          </h1>
          {
            subStageName==='İş təcrübəsi substage'?<ProgressBar progress={Number(page)===2? 100:50} />:  <ProgressBar progress={progress} />
          }
