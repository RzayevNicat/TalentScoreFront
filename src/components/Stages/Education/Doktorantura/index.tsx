...
import { addDataPage, addEducation,addEducationPage } from 'state/dataSlice';
        ...
        {({ values, errors, touched }) => (
          <Form className="form ">
            <div className="form-education ">            
              <label><span>Doktorantura</span> {questionsDatas[0]?.question_title} </label>
            ...
            <div className="sbmt">
            <button type="submit" className="submitForm">Yadda saxla <AiOutlineCheck/></button>
            </div>
